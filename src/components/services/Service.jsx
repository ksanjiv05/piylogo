const Service = () => {
  return (
    <div id="services" class="w-full mt-[80px] p-[80px] bg-white">
      ...
      <div class="grid grid-cols-2 gap-[30px]">
        <div class="rounded-[20px] my-[30px] overflow-hidden">
          ...
          <div class="w-full    p-[30px]  bg-[#333333]  h-[100%]">
            ...
            <button class="bg-[#ffffff] mt-4 text-black text-[24px] px-[32px] py-[16px]  font-bold rounded-full font-nunito">
              Contact
            </button>
          </div>
        </div>
